...
public class ClothModel2 extends Model{

    float startX=-3, startY=3, edge = 1;
    int pWid=9, pHeg=9; 
    float k = 70;
    ...
    public ClothModel2(){
        ...
        particleArray[0][0].passive = true;
        particleArray[0][0].stable = true;
        particleArray[0][pWid-1].passive = true;
        particleArray[0][pWid-1].stable = true;
